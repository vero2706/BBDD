...
select UnitPrice, UnitPrice * 1.15 as precioAumentado from products p inner join categories c on p.CategoryID = c.CategoryID  where c.Description like 'Cheeses';
...
select o.OrderID, c.ContactName, p.ProductName, (od.quantity * od.unitPrice) - od.Discount as GastadoEnPedido
...
Select orderID, Freight, Freight * 1.1 as ImpuestoEnvio 
...
select  p.ProductName, o.OrderID, (o.Discount / o.UnitPrice) * 100 as TantoPorCiento 
