...
-- Libros
   ...
   Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00010','LIB','Oracle Database 10g','Eric G. Coronel Castillo',1,75.00,5000);
       Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00011','LIB','Harry Potter y la piedra filosofal','Eric G. Coronel Castillo',1,75.00,5000);
           Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00012','LIB','Harry Potter y la piedra filosofal','J. K. Rowling',1,75.00,5000);
               Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00013','LIB','Harry Potter y el prisionero de Azkaban','J. K. Rowling',1,75.00,5000);
                   Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00014','LIB','Cien años de soledad','Gabriel García Márquez',1,75.00,5000);
                       Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00015','LIB','El coronel no tiene quien le escriba','Gabriel García Márquez',1,75.00,5000);
    
                       Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00016','LIB','La guerra civil contada a los jóvenes','Arturo Pérez Reverte',2,50.00,1000);
                           Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00017','LIB','El coronel no tiene quien le escriba','Arturo Pérez Reverte',1,70.00,5000);
                           Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00018','LIB','Hombres buenos','Arturo Pérez Reverte',1,70.00,5000);
                           Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00019','LIB','La sombra del águila','Arturo Pérez Reverte',1,70.00,5000);
                           Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00020','LIB','La Reina del Sur','Arturo Pérez Reverte',1,20.00,2500);
    
                           Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00021','LIB','Sunset Park','Paul Auster',1,25.00,2500);
                           Insert Into publicacion( idpublicacion,idtipo,titulo,autor,nroedicion,precio,stock ) 
    Values('LIB00022','LIB','Leviatán','Paul Auster',1,30.00,2500);
